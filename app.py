...
with col2:
    search_query = st.text_input("ادخل رقم الجلوس أو اسم الطالب:")
...
if show_button:
    if search_query:
        ...
        if match_indices:
            ...
            st.error("لم يتم العثور على نتائج مطابقة، تأكد من رقم الجلوس أو اسم الطالب.")
    else:
        st.warning("الرجاء إدخال رقم الجلوس أو اسم الطالب أولاً.")

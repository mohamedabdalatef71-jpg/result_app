    ...
    if seat_no:
        ...
        if seat_col in df.columns:
            ...
            if match_indices:
                ...
                rows_html += '<tr><th style="background-color: #1b4d3e; color: white; text-align: right; padding: 12px 15px; white-space: nowrap;">المواد</th><th style="background-color: #1b4d3e; color: white; text-align: right; padding: 12px 15px; border-right: 2px solid #b8860b;">التقديرات / الدرجات</th></tr>'

...
if LOGO_URL:
    logo_img_tag = f'<img src="{LOGO_URL}" style="max-height: 65px; margin-bottom: 2px; display: block; margin-right: 0; margin-left: auto; mix-blend-mode: multiply;" alt="شعار الكلية">'
else:
    logo_img_tag = '<div style="font-size: 35px; color: #1b4d3e; margin-bottom: 2px;">🏛️</div>'
    ...
    if seat_no:
        ...
        if seat_col in df.columns:
            ...
            if match_indices:
                ...
                rows_html += '<tr><th style="background-color: #1b4d3e; color: white; text-align: right; padding: 7px 10px; white-space: nowrap;">المواد</th><th style="background-color: #1b4d3e; color: white; text-align: right; padding: 7px 10px; border-right: 2px solid #b8860b;">التقديرات / الدرجات</th></tr>'
                ...
                <head>
                    ...
                    <style>
                        body {{ font-family: 'Cairo', sans-serif; background-color: #ffffff; margin: 0; padding: 0; display: flex; flex-direction: column; align-items: center; justify-content: flex-start; }}
                        .print-page-wrapper {{ 
                        ...
                        .print-header-title {{ font-family: 'Amiri', serif; text-align: center; color: #2e8b57; font-size: 22px; font-weight: bold; margin-bottom: 0px; position: relative; z-index: 2; }}
                        .print-header-subtitle {{ text-align: center; color: #d4af37; font-size: 15px; font-weight: bold; margin-bottom: 2px; position: relative; z-index: 2; }}
                        .print-ayah {{ text-align: center; color: #2e8b57; font-family: 'Amiri', serif; font-weight: bold; font-size: 13px; margin-bottom: 6px; position: relative; z-index: 2; }}
                        .table-container {{ width: 100%; display: flex; justify-content: center; margin-bottom: 6px; position: relative; z-index: 2; }}
                        .styled-table {{ direction: rtl; border-collapse: separate; border-spacing: 0; font-size: 13.5px; background-color: rgba(255, 255, 255, 0.95); color: #000000; border: 2px solid #1b4d3e; border-radius: 8px; overflow: hidden; width: 100%; }}
                        .styled-table th {{ background-color: #1b4d3e; color: #ffffff; padding: 6px 10px; font-size: 14px; border-bottom: 2px solid #1b4d3e; border-right: 2px solid #b8860b; }}
                        .styled-table th:first-child {{ border-right: none; }}
                        .styled-table td {{ padding: 5px 10px; border-bottom: 1px solid #e0e0e0; border-right: 2px solid #1b4d3e; color: #000000; font-weight: bold; }}
                        ...
                        /* آية الكرسي مضغوطة ومنسقة بدقة في المساحة المتبقية */
                        .kursi-text {{
                        ...
                        .college-name {{ font-family: 'Amiri', serif; font-size: 12px; font-weight: bold; color: #d4af37; }}
                        .designer-credit {{ font-size: 10.5px; font-weight: bold; color: #2e8b57; }}
                        
                        /* العلامة المائية في منتصف الجدول وبشفافية خفيفة */
                        .watermark-logo {{ 
                            position: absolute; 
                            top: 52%; 
                            left: 50%; 
                        ...
                        .print-btn-container {{ margin-top: 15px; text-align: center; width: 100%; }}
                        .print-btn {{
                ...
                <body>
                    <div class="print-page-wrapper">
                        <!-- العلامة المائية في منتصف الجدول -->
                        ...
                        <!-- آية الكرسي كاملة في المساحة تحت الجدول -->
                ...
                """
                # تم تقليل الـ height الخاص بالـ component لإزالة أي مساحة بيضاء زائدة من الأسفل
